...
-- VersionTypes
INSERT INTO VersionTypes (name) VALUES ('original'), ('acoustic'), ('remix'), ('nightcore'), ('full');

-- MusicAlbums
INSERT INTO MusicAlbums (title, artist_id, release_year) VALUES 
('Przeznaczenie', 1, 2003), 
('Playing with Pop', 3, 2009),
('To nie tak jak myslisz, kotku!', 5, 2008),
...
('Chlopi', 15, 2023),
('Hamilton', 18, 2015),
('Mercurial World', 19, 2021),
('Arcane League of Legends: Season 2', 20, 2024);
...
('Wiernosc jest nudna', 9, 2011, 1),
('Radio Song', 2, 2009, 1),
('To nie tak jak myslisz', 3, 2008, 1),
('Zanim pojde', 4, 2004, 1),
('No Hay 2 Sin 3', 5, 2012, 3),
('La nit ferida', 6, 2022, 4),
('Satellite', 7, 2017, 2),
('Dlugosc dzwieku samotnosci', 8, 1999, 1),
('Bodies', 10, 2000, 2),
('Heat Waves', 11, 2020, 2),
('Wilcza zamiec', 9, 2015, 1),
('Jesien - Tancuj', 12, 2023, 1),
('Satisfied', 13, 2015, 2),
('Chaeri', 14, 2021, 2),
('Ma meilleure ennemie', 15, 2024, 5);
